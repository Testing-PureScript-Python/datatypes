...
res = block( "No document"
           , assign_star( "$foreign"
                        , call( var('import_module')
                              , "datatypes.ffi.Control.Apply" ) )
           , assign_star( "ps_Control_Category"
                        , call( var('import_module')
                              , "datatypes.Control.Category.pure" ) )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Control\\Apply.purs", name="datatypes.Control.Apply.pure")
