                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( ite( uop( UOp.NOT
                                                                               ...
                                                                               , throw( call( var( "Error" )
                                                                                            , binop( "Failed pattern match at datatypes.Control.Applicative.pure (line 62, column 1 - line 62, column 65): "
                                                                                                   , BinOp.ADD
                                                                                                   , call( get_attr( ","
                                                                                                                   , "join" )
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( ite( var( "ps_v" )
                                                                               ...
                                                                               , ite( uop( UOp.NOT
                                                                                    ...
                                                                                    , None )
                                                                               , throw( call( var( "Error" )
                                                                                            , binop( "Failed pattern match at datatypes.Control.Applicative.pure (line 57, column 1 - line 57, column 63): "
                                                                                                   , BinOp.ADD
                                                                                                   , call( get_attr( ","
                                                                                                                   , "join" )
                                                                                                         , mktuple( get_attr( get_item( var( "ps_v" )
                        ...
                        , new( var("ps_Applicative")
                             ...
                             , define( None
                                     ...
                                     , block( ret( metadata( 40
                                                           , 12
                                                           , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Control\\Applicative.purs"
                                                           , mktuple( var( "ps_x" ) ) ) ) ) ) ) )
           , assign( "exports"
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Control\\Applicative.purs", name="datatypes.Control.Applicative.pure")
