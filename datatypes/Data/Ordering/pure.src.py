                             ...
                             , define( None
                                     ...
                                     , block( ite( isa( var("ps_v")
                                                 ...
                                                 , block( ret( metadata( 28
                                                                       , 13
                                                                       , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Ordering.purs"
                                                                       , "LT" ) ) )
                                                 , None )
                                            , ite( isa( var("ps_v")
                                                      , var("ps_GT") )
                                            ...
                                            , throw( call( var("Error")
                                                         , binop( "Failed pattern match at datatypes.Data.Ordering.pure (line 26, column 1 - line 29, column 17): "
                                                                , BinOp.ADD
                                                                , call( get_attr( ","
                                                                                , "join" )
                                     ...
                                     , block( ret( define( None
                                                         ...
                                                         , block( ite( isa( var( "ps_v" )
                                                                ...
                                                                , ite( isa( var( "ps_v" )
                                                                     ...
                                                                     , None )
                                                                , throw( call( var( "Error" )
                                                                             , binop( "Failed pattern match at datatypes.Data.Ordering.pure (line 21, column 1 - line 24, column 18): "
                                                                                    , BinOp.ADD
                                                                                    , call( get_attr( ","
                                                                                                    , "join" )
                                                                                          , mktuple( get_attr( get_item( var( "ps_v" )
                        ...
                        , define( None
                                ...
                                , block( ite( isa(var("ps_v"), var("ps_GT"))
                                       ...
                                       , ite( isa(var("ps_v"), var("ps_LT"))
                                            ...
                                            , None )
                                       , throw( call( var("Error")
                                                    , binop( "Failed pattern match at datatypes.Data.Ordering.pure (line 33, column 1 - line 33, column 31): "
                                                           , BinOp.ADD
                                                           , call( get_attr( ","
                                                                           , "join" )
                                                                 , mktuple( get_attr( get_item( var( "ps_v" )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Ordering.purs", name="datatypes.Data.Ordering.pure")
