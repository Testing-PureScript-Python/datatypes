...
res = block( "No document"
           ...
           , assign_star( "ps_monoidString"
                        , new( var("ps_Monoid")
                             ...
                             , metadata( 45
                                       , 12
                                       , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Monoid.purs"
                                       , "" ) ) )
                                                                        ...
                                                                        , define( None
                                                                                ...
                                                                                , block( ite( cmp( var( "ps_p" )
                                                                                       ...
                                                                                       , throw( call( var( "Error" )
                                                                                                    , binop( "Failed pattern match at datatypes.Data.Monoid.pure (line 65, column 3 - line 65, column 17): "
                                                                                                           , BinOp.ADD
                                                                                                           , call( get_attr( ","
                                                                                                                           , "join" )
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( ite( var( "ps_v" )
                                                                               ...
                                                                               , ite( uop( UOp.NOT
                                                                                    ...
                                                                                    , None )
                                                                               , throw( call( var( "Error" )
                                                                                            , binop( "Failed pattern match at datatypes.Data.Monoid.pure (line 73, column 1 - line 73, column 49): "
                                                                                                   , BinOp.ADD
                                                                                                   , call( get_attr( ","
                                                                                                                   , "join" )
...
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Monoid.purs", name="datatypes.Data.Monoid.pure")
