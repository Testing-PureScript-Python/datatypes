...
res = block( "No document"
           , assign_star( "$foreign"
                        , call(var('import_module'), "datatypes.ffi.Data.Ord") )
           , assign_star( "ps_Data_Eq"
                        , call(var('import_module'), "datatypes.Data.Eq.pure") )
           , assign_star( "ps_Data_Ordering"
                        , call( var('import_module')
                              , "datatypes.Data.Ordering.pure" ) )
           , assign_star( "ps_Data_Ring"
                        , call( var('import_module')
                              , "datatypes.Data.Ring.pure" ) )
           , assign_star( "ps_Data_Semiring"
                        , call( var('import_module')
                              , "datatypes.Data.Semiring.pure" ) )
           , assign_star( "ps_Data_Symbol"
                        , call( var('import_module')
                              , "datatypes.Data.Symbol.pure" ) )
           , assign_star( "ps_Record_Unsafe"
                        , call( var('import_module')
                              , "datatypes.Record.Unsafe.pure" ) )
           , assign_star( "ps_Type_Data_RowList"
                        , call( var('import_module')
                              , "datatypes.Type.Data.RowList.pure" ) )
                                     ...
                                     , block( ret( define( None
                                                         ...
                                                         , block( ite( ite( isa( var( "ps_v" )
                                                                ...
                                                                , throw( call( var( "Error" )
                                                                             , binop( "Failed pattern match at datatypes.Data.Ord.pure (line 112, column 1 - line 119, column 21): "
                                                                                    , BinOp.ADD
                                                                                    , call( get_attr( ","
                                                                                                    , "join" )
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                    ...
                                                                                    , block( ret( metadata( 131
                                                                                                          , 9
                                                                                                          , "C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Ord.purs"
                                                                                                          , True ) ) )
                                                                                    , None )
                                                                               , ret( metadata( 132
                                                                                              , 8
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                    ...
                                                                                    , None )
                                                                               , throw( call( var( "Error" )
                                                                                            , binop( "Failed pattern match at datatypes.Data.Ord.pure (line 167, column 3 - line 170, column 12): "
                                                                                                   , BinOp.ADD
                                                                                                   , call( get_attr( ","
                                                                                                                   , "join" )
                                                                                                         , mktuple( get_attr( get_item( var( "ps_v" )
                                                    ...
                                                    , block( ret( define( None
                                                                        ...
                                                                        , block( assign_star( "ps_v"
                                                                               ...
                                                                               , ite( isa( var( "ps_v" )
                                                                                    ...
                                                                                    , None )
                                                                               , throw( call( var( "Error" )
                                                                                            , binop( "Failed pattern match at datatypes.Data.Ord.pure (line 158, column 3 - line 161, column 12): "
                                                                                                   , BinOp.ADD
                                                                                                   , call( get_attr( ","
                                                                                                                   , "join" )
                                                                                                         , mktuple( get_attr( get_item( var( "ps_v" )
                                                                                           ...
                                                                                           , block( ret( define( None
                                                                                                               ...
                                                                                                               , block( assign_star( "ps_v"
                                                                                                                      ...
                                                                                                                      , ite( isa( var( "ps_v" )
                                                                                                                           ...
                                                                                                                           , None )
                                                                                                                      , throw( call( var( "Error" )
                                                                                                                                   , binop( "Failed pattern match at datatypes.Data.Ord.pure (line 65, column 7 - line 68, column 17): "
                                                                                                                                          , BinOp.ADD
                                                                                                                                          , call( get_attr( ","
                                                                                                                                                          , "join" )
                                                                                                                                                , mktuple( get_attr( get_item( var( "ps_v" )
           ...
           , assign( "exports"
                   , record( ("Ord", var("ps_Ord"))
                           ...
                           , ("ordRecord", var("ps_ordRecord")) ) ) )
res = module_code(res, filename="C:\\Users\\twshe\\Desktop\\mydb\\com-haskell\\testing\\datatypes\\.spago\\prelude\\v4.1.1\\src\\Data\\Ord.purs", name="datatypes.Data.Ord.pure")
